...
export const glassVariants = {
  button: {
    ...
    success: 'bg-green-500/20 hover:bg-green-500/30 border border-green-400/30 backdrop-blur-md shadow-lg'
  },
  panel: {
  ...
  input: {
    default: 'bg-white/10 border border-white/20 backdrop-blur-md focus:bg-white/15 focus:border-white/30',
