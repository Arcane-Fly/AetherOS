        ...
        <div>
          ...
          {message.generationType && (
            <div className="mt-2 flex items-center gap-2">
              <span
                className={`px-2 py-1 text-xs rounded-full ${getTypeColor(message.generationType)}`}
              >
  ...
  return (
    <div className="flex flex-col h-full">
        ...
        {messages.map((message) => (
          ...
          >
            <GlassPanel
              ...
              animate={false}
            >
              <div className="text-white/95">{formatMessage(message)}</div>
      ...
      <GlassPanel className="p-4 mt-4" variant="elevated" animate={false}>
        ...
        <div className="mt-2 text-xs text-white/60">{getExampleText(generationType)}</div>
      </GlassPanel>
    </div>
  );
};
